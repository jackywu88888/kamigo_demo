Rails.application.routes.draw do
  ...
  get "7-11超商/電子票證可參照自動加值各項行動支付可參照行動支付", to: "video20#index"
  get "全家超商/電子票證可參照自動加值各項行動支付可參照行動支付", to: "video21#index"
  get "萊爾富OK超商/電子票證可參照自動加值各項行動支付可參照行動支付", to: "video22#index"
