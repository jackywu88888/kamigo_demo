class Inquires4Controller < ApplicationController
    def index
      @inquires4 = [
        {
          "活動": "1.【追劇贈點】你就是我的✨萬靈丹✨👫連續五天觀看指定戲劇完成任務得 LINE POINTS 5點!",
