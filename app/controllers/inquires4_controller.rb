class Inquires4Controller < ApplicationController
    def index
      @inquires4 = [
        {
          "活動": "1.【追劇贈點】趕快許願！見證聖誕當下的心動瞬間💗 完成觀劇任務得LINE POINTS 5點！(只限點擊活動連結，LINE POINTS 活動點數數量有限，活動期間送完為止）限1,000人得點！",
          "影片": "活動期間：2021/12/25~2021/12/31\\n\\n《My Sweet Dear 美味羅曼史 電影版》\\n➡️ https://bnc.lt/MuAd/uqcM0nGb9lb",
        },
        {
          "活動": "2.【追劇贈點】大時代裡愛要綻放🌼，連續五天每天完整觀看完成追劇任務得 LINE POINTS 5 點！(只限點擊活動連結，LINE POINTS 活動點數數量有限，活動期間送完為止）限1,000人得點！",
