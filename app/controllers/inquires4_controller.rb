class Inquires4Controller < ApplicationController
    def index
      @inquires4 = [
        {
          "活動": "1.【追劇贈點】《全明星運動會 第三季》明星賽事精彩全新季，熱血持續燃燒！完整觀看指定戲劇任一集，完成追劇任務得10點！",
          "影片": "活動期間：活動期間：2021/12/06~2021/12/11\\n\\n《全明星運動會 第三季》\\n\\n👉https://bnc.lt/MuAd/svsKioPprlb",
        },
        {
          "活動": "2.【追劇贈點】你就是我的✨萬靈丹✨👫連續五天觀看指定戲劇完成任務得 LINE POINTS 5點!",
