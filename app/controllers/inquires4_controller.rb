class Inquires4Controller < ApplicationController
    def index
      @inquires4 = [
        {
          "活動": "1.【追劇贈點】大時代裡愛要綻放🌼，連續五天每天完整觀看完成追劇任務得 LINE POINTS 5 點！(只限點擊活動連結，LINE POINTS 活動點數數量有限，活動期間送完為止）限1,000人得點！",
          "影片": "活動期間：\\n\\n2021/12/22~2021/12/28《靈丹妙藥不及你》\\n➡️https://bnc.lt/MuAd/10PrrotsYlb",
        },
        {
          "活動": "2.【追劇贈點】《茶金》一段台灣茶商輝煌史！連續三天看指定戲劇得LINE POINTS 3點！(只限點擊活動連結，LINE POINTS 活動點數數量有限，活動期間送完為止）限1,000人得點！",
          "影片": "活動期間：2021/12/19~2021/12/24\\n\\n《茶金》\\n➡️https://bnc.lt/MuAd/TRD7pyJprlb",
        },
        {
          "活動": "3.【追劇贈點】奉行曖昧至上主義👩‍❤️‍💋‍👨連續五天觀看指定戲劇一集得5點！\\n此檔LINE POINTS 活動點數數量有限，活動期間送完為止限1,000人得點",
