class Inquires4Controller < ApplicationController
    def index
      @inquires4 = [
        {
          "活動": "1.【追劇贈點】⭐️人氣王就是你⭐️一秒擁有好人緣🥳 連續五天觀看指定戲劇任務得LINE POINTS 5點！",
          "影片": "活動期間：2022/01/06~2022/01/13\\n\\n《凜子小姐想試愛》\\n👉 https://bnc.lt/MuAd/7NiEZPOvvmb",
        },
        {
          "活動": "2.【追劇贈點】2022新年追新劇，熱播話題別錯過！完成任務得LINE POINTS 5點！",
        ...
        {
          "活動": "4.【VIP會員限定】家家有本難念的經！👨‍👩‍👧‍👦 完成追劇任務得 LINE POINTS 10點，再抽《斯卡羅》限量紀念徽章組！",
