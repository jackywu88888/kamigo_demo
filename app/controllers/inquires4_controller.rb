class Inquires4Controller < ApplicationController
    def index
      @inquires4 = [
        {
          "活動": "1.【追劇贈點】跨年不想人擠人👨‍👩‍👧‍👦跨年攻略陪你迎2022🎉完成觀劇任務得LINE POINTS 10點！(只限點擊活動連結，LINE POINTS 活動點數數量有限，活動期間送完為止）限1,000人得點！",
          "影片": "活動期間：活動期間：2021/12/27~2022/01/03\\n\\n《恐懼事件簿（電視劇版）》\\n👉 https://bnc.lt/MuAd/Wae9KQJcamb",
        },
        {
          "活動": "2.【VIP會員限定】家家有本難念的經！👨‍👩‍👧‍👦 完成追劇任務得 LINE POINTS 10點，再抽《斯卡羅》限量紀念徽章組！",
