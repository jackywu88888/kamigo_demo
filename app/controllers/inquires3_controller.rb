class Inquires3Controller < ApplicationController
    def index
      @inquires3 = [
        {
          "活動1": "1.點選下面網址領取10,000振興幣，以註冊QPP數位背包APP之門號發送領取簡訊。https://www.xin-stars.com/2021GetCash?sharecode=SU30UET3",
          "活動2": "2.下載QPP數位背包APP註冊，需與星城註冊同門號。https://www.qpptec.com/",
          "活動3": "3.註冊星城帳號的門號必需與QPP APP相同並設定寶物密碼，進下面網址→(立即玩)登入星城帳號、密碼→創建新角色。https://www.xin-stars.com/",
