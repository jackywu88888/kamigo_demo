...
#        },
        ...
        {
          "說明": "COLDSTONE官帳【傳說對決抽抽樂】\n小杯冰淇淋+原味脆餅/冰淇淋買一送一/桶裝買一送一/冰淇淋第2杯$50/冰淇淋第2杯半價。效期11/10。數量有限，贈完為止。",
          "名稱": "COLDSTONE官帳",
          "時間": "⏰9/16～11/3⚠️需綁定好友才能玩",
          "連結": "https://liff.line.me/1654051534-Wo8QNR0Y?gameId=50",
          "查詢": "COLDSTONE官帳",
        },
        {
          "說明": "Coca-Cola 隨時樂 LINE官號\n【2022今夏喝Coke®，天天刮好禮帶回家！】\n🎁Coke Cola 超輕量收納背包",
          "名稱": "Coca-Cola",
          "時間": "9/3~10/15",
          "連結": "https://2022coke.medialand.com.tw/summerevent/",
          "查詢": "Coca-Cola",
        },
#        {
...
#        },
        ...
        # "NO0"
#        {
#          "說明": "HAPPY GO APP活動\n📣HAPPY GO的「集滿嫦娥奔月，最高拿兩百點！」\n🎁集滿四字抽200點、1點HG點，24小時內歸戶。",
#          "名稱": "HAPPY GO",
#          "時間": "9/2～9/6每天刮三次，效期至2023/1/31",
#          "連結": "https://hgapp.page.link/CppvUk74PHYRVKrs9",
#          "查詢": "HAPPYGO",
#        },
        ...
        # "NO5"        
        {
          ...
          "名稱": "HAPPY GO",
          "時間": "⏰9/19～10/9",
          "連結": "https://hgapp.page.link/uENEJbhtR6EQTqWL6",
          "查詢": "HAPPYGO",
        },
        # "NO6"
        {
          "說明": "HAPPY GO APP活動\n台塑集團★福機裝★光立潔除菌棒\n➡️翻出兩張一樣牌面！挑戰成功領好禮(不限次數)\n🎁奬項：10/14公布名單，隨即歸戶，效期2023/12/31\n⑴速度獎：取整個活動期間最快速度前三名\n❶第一名：5000點HG點\n❷第二名：3000點HG點\n❸第三名：1000點HG點\n\n⑵努力奬：取整個活動期間玩最多次數前二名各500點HG貼",
          "名稱": "HAPPY GO",
          "時間": "⏰9/19～10/2",
          "連結": "https://ppt.cc/fhk5Nx",
          "查詢": "HAPPYGO",
        },
        # "NO7"
#        {
...
#        },
      ...
      #  APP活動選輯(二)
        ...
        #  "連結": "https://mcdweb.mcddailyapp.com.tw/game/v2/mcdonald.html?actionType=1&parameters=1559027385531068417&openexternalbrowser=1",
          "連結": "https://mcdweb.mcddailyapp.com.tw/game/v2/mcdonald.html?actionType=1&parameters=1572106185560309761&openexternalbrowser=1",
          "查詢": "麥當勞",
        },
        {
          "說明": "快來填問卷，回饋賺起來",
        ...
        #  "連結": "https://mcdweb.mcddailyapp.com.tw/game/v2/mcdonald.html?actionType=1&parameters=1556896263285592066&openexternalbrowser=1",
          "連結": "https://mcdweb.mcddailyapp.com.tw/game/v2/mcdonald.html?actionType=1&parameters=1570010814700449793&openexternalbrowser=1",
          "查詢": "麥當勞",
        },
        {
...
#        },
        ...
        {
          "說明": "7-ELEVEN /遊樂場【國際咖啡日翻翻樂】\n每人每天可各玩2次\n🎁指定CITY系列品項任選2杯半價優惠(不限冰熱) (另有55、7、75、85折，五捨六入計算)",
          "名稱": "7-ELEVEN",
          "時間": "⏰9/21～10/18 19:00 (券使用到23:59)",
          "連結": "https://bit.ly/3llMWVQ",
          "查詢": "7-ELEVEN",
        },
#        {
#          "說明": "OPEN POINT APP【遊樂場】\n1500萬會員慶刮寳趣天天免費刮乙次\n🎁SONY PS5、15000點OP點等好禮\n❷OPEN遊樂園--轉動吧！摩天好禮任你拿\n",
#          "名稱": "7-ELEVEN",
#          "時間": "開幕期間免費玩三次，8/18之後每天免費玩一次",
