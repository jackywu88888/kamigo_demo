class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "為老師們送上真摯祝福！連續5天觀看指定戲劇得LINE POINTS 5點",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《當你年少時》",
          "時間": "2022/09/28~2022/10/05",
          "影片": "https://bnc.lt/MuAd/J9aIR1liCtb",
          "圖片": "https://img.linetv.tw/large/campaign/220928_campaign_teacher.jpg",
        },

        {
          "活動": "怦然心動💗給你滿滿戀愛感💗觀看指定戲劇1集得5點，VIP翻倍送！",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《雙面贅婿第二季》",
          "時間": "2022/09/24~2022/10/01",
          "影片": "https://bnc.lt/MuAd/w9ftwb4bvtb",
          "圖片": "https://img.linetv.tw/large/campaign/220924_Heart_W960xH540.png",
        },
