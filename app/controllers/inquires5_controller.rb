class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        {
          "活動": "《極島森林》重回17歲那年夏天 ！限時72H，完成任務得6點，VIP會員加碼再抽親簽拍立得！",
          "活動主題": "追劇贈點",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n數量有限，活動期間送完為止\\n活動期間內，\\n觀看的戲劇集數均不可重複。",
          "名稱": "《極島森林》",
          "時間": "2022/07/08~2022/07/10",
          "影片": "https://bnc.lt/MuAd/WqYJg8xBXqb",
          "圖片": "https://img.linetv.tw/large/campaign/campaign_extremeforest_22070801.png",
        },
        {
          "活動": "戀夏進行曲 🎼 抓住愛情的美好 💕 連續五天完成追劇任務得 LINE POINTS 5 點，VIP 翻倍送！",
          "活動主題": "追劇贈點",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n數量有限，活動期間送完為止\\n活動期間內，\\n觀看的戲劇集數均不可重複。",
          "名稱": "《SPY×FAMILY 間諜家家酒》",
          "時間": "2022/07/07~2022/07/13",
          "影片": "https://bnc.lt/MuAd/yznf2Jnzqrb",
          "圖片": "https://img.linetv.tw/large/campaign/220707_Campaign.jpg",
        },
