class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [     
        {
          "活動": "命運的相遇 💓 連續五天觀看指定戲劇一集得 LINE POINTS 5 點、VIP 得 10 點！",
          "活動主題": "追劇贈點",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n數量有限，活動期間送完為止\\n活動期間內，\\n觀看的戲劇集數均不可重複。",
          "名稱": "《虛構推理》",
          "時間": "2022/07/26~2022/08/01",
          "影片": "https://bnc.lt/MuAd/IsMStmuyWrb",
          "圖片": "https://img.linetv.tw/large/campaign/campaign_VIP_220726.png",
        },
        {
