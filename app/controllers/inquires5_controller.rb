class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "歡迎光臨 等你來家1》完成觀劇任務得1點、大螢幕追劇🖥加碼送！",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "歡迎光臨 等你來家1",
          "時間": "2022/10/15~2022/10/16",
          "影片": "https://bnc.lt/MuAd/i1GARz566tb",
          "圖片": "https://img.linetv.tw/large/campaign/221015_welcomehome_points.jpg",
        }

        {
          ...
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "SPY×FAMILY間諜家家酒",
          "時間": "2022/10/14~2022/10/21",
          "影片": "https://bnc.lt/MuAd/CNa2kyoq3tb",
          "圖片": "https://img.linetv.tw/large/campaign/221014_fall_W960xH540.png",
        },
