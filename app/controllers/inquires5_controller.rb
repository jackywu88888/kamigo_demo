class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "暖心治癒輕鬆追劇～連續五天觀看指定戲劇一集得5點、VIP得10點",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《戀愛的季節》",
          "時間": "2022/10/22~2022/10/29",
          "影片": "https://bnc.lt/MuAd/BiAJuuR6eub",
          "圖片": "https://img.linetv.tw/large/campaign/221022_warm_W960xH540.png",
        },
