class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "秋意濃情時刻！連續觀看指定戲劇5天得LINE POINTS 5點",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《親愛的小美人魚》",
          "時間": "2022/09/20~2022/09/27",
          "影片": " https://bnc.lt/MuAd/IavEEnhFrtb",
          "圖片": "https://img.linetv.tw/large/campaign/20220920_pointsevent.jpg",
        },
