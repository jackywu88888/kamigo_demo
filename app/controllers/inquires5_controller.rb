class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "魔幻驚魂夜～連續五天觀看指定戲劇一集得5點、VIP得10點（只要完成任務條件即可得點🔥）",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《戀愛的季節》",
          "時間": "2022/10/30~2022/11/06",
          "影片": "https://bnc.lt/MuAd/nDisfHIQtub",
          "圖片": "https://img.linetv.tw/large/campaign/221030night_W960xH540.png",
        },

        {
          "活動": "LINE TV好戲精選，限時追劇再送點！看越多賺越多！",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《熾道》",
          "時間": "2022/10/28~2022/10/31",
          "影片": "https://bnc.lt/MuAd/0YEcZ8LQfub",
          "圖片": "https://img.linetv.tw/large/campaign/campaign_linetv_22102801.png",
        },

        {
          "活動": "萬聖節之夜！連續五天觀看指定戲劇一集得5點",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《當你年少時》",
          "時間": "2022/10/26~2022/11/02",
          "影片": "https://bnc.lt/MuAd/zKbTSPQkpub",
          "圖片": "https://img.linetv.tw/large/campaign/221026_campaign_halloween.png",
        },


#        {
#          "活動": "只要有愛！BL無所不在💖 BL劇限時免費任你看❗\\n連續三天完成追劇任務得3點",
#          "活動主題": "追劇贈點/不限量",
#          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
#          "名稱": "致我的星星2",
#          "時間": "2022/10/13~2022/10/17",
#          "影片": "https://bnc.lt/MuAd/PysAZCut3tb",
#          "圖片": "https://img.linetv.tw/large/campaign/cam_BL_POINTS_1013.png",
#        },

#        {
#          "活動": "追劇療癒正能量！消除你的負能量！連續觀看指定戲劇5天得LINE POINTS 5點",
##          "活動主題": "追劇贈點/不限量",
#          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
#          "名稱": "SPY×FAMILY 間諜家家酒",
#         "時間": "2022/10/10~2022/10/17",
#          "影片": "https://bnc.lt/MuAd/nz5FL5iETtb",
#          "圖片": "https://img.linetv.tw/large/campaign/20221010_LINEPOINTS_BN.png",
#        },
