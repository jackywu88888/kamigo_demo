class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "追劇放輕鬆！超Chill! 連續觀看指定戲劇5天得LINE POINTS 5點",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "我家隔壁的校草男友",
          "時間": "2022/09/12~2022/09/19",
          "影片": "https://bnc.lt/MuAd/j8gWZ8cG9sb",
          "圖片": "https://img.linetv.tw/large/campaign/20220912_campaign.png",
        },

        {
          "活動": "中秋節追劇攻略！連續五天觀看指定戲劇一集得5點、VIP得10點，只要完成任務條件即可得點🔥。",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《雙面贅婿第一季》",
          "時間": "2022/09/08~2022/09/15",
          "影片": "https://bnc.lt/MuAd/rpmztuktZsb",
          "圖片": "https://img.linetv.tw/large/campaign/campaign_points_0908.png",
        },
