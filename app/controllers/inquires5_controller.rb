class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "眾多好劇幫你涼ㄧ夏！消暑大作戰即刻展開🥁連續三天觀看指定戲劇1集得3點、VIP得5點！",
          "活動主題": "追劇贈點",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "Mimicus 模仿者",
          "時間": "2022/08/12~2022/08/16",
          "影片": "https://bnc.lt/MuAd/ElIYtEMpqsb",
          "圖片": "https://img.linetv.tw/large/campaign/summarwar.jpg",
        },  
        {
