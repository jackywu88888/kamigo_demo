class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        {
          "活動": "放鬆一夏 🏖 看好劇 👀 連續五天完成追劇任務得 LINE POINTS 5 點，VIP 翻倍送！",
          "活動主題": "追劇贈點",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n數量有限，活動期間送完為止\\n\\n唯一POINTS點收入要注意，使用期限。",
          "名稱": "《叫我野孩子》",
          "時間": "2022/06/17~2022/06/23",
          "影片": "https://bnc.lt/MuAd/ngUrAXlTQqb",
          "圖片": "https://img.linetv.tw/large/campaign/220617_campaign.png",
        },
        {
