class Inquires5Controller < ApplicationController
    def index
      @inquires5 = [
        ...
        {
          "活動": "戀愛必修課，心動開課中💗觀看指定戲劇1集得5點，VIP翻倍送！",
          "活動主題": "追劇贈點/不限量",
          "限量或VIP": "此檔LINE POINTS 活動點數\\n活動期間內\\n只要完成任務條件即可得點\\n觀看的戲劇集數均不可重複。",
          "名稱": "《消失的孩子》",
          "時間": "2022/09/16~2022/09/23",
          "影片": "https://bnc.lt/MuAd/KFwUZWq8ktb",
          "圖片": "https://img.chocotv.com.tw/raw_images/campaign/0916W960xH540.jpg",
        },
